...
getGPIOInput:	
	...
	ldr r6, =myloc
 	ldr r1, [r6]		@ obtener direccion de la memoria virtual 
	ldr r1,[r1,#0x34]	@Direccion r0+0x34:lee en r5 estado de puertos de entrada
	mov r2,#1
	lsl r2,r0
	and r1,r2 		@se revisa el bit en r0 enviado por la subrutina (puerto de entrada)
	teq r1,#0
	moveq r0,#0
	movne r0,#1
	pop {pc}